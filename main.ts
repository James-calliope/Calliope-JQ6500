...
//% weight=9 color=#666666 icon="\uf001" block="JQ6500"
namespace JQ6500 {
     ...
     */
    //% blockId="JQ6500_connect" block="connect to JQ6500, RX:%pinRX|TX:%pinTX"
    ...
    //% blockId="JQ6500_press" block="press button:%myPlayType"
    //% weight=99 blockGap=20
    export function press(myPlayType: playType): void {
        innerCall(myPlayType, 0x00, 0x00)
    }

    //% blockId="JQ6500_playFile" block="play JQ6500 on the file number:%fileNumber|repeat:%setRepeat"
    ...
    //% blockId="JQ6500_playFileInFolder" block="play JQ6500 in the folder number:%folderNumber|file number:%fileNumber|repeat:%setRepeat"
    ...
    //% blockId="JQ6500_playLoopAllFiles" block="loop play all the files in the SD card"
    //% weight=96 blockGap=20 
    export function playLoopAllFiles(): void {
        innerCall(0x11, 0x00, 0x01)
    }

    //% blockId="JQ6500_playLoopFolder" block="loop play all the files in the folder:%folderNum"
    ...
    //% blockId="JQ6500_setVolume" block="set volume(0~30):%volume"
    //% weight=94 blockGap=20 volume.min=0 volume.max=30
    export function setVolume(volume: number): void {
        innerCall(0x06, 0x00, volume | 0)
    }

    //% blockId="JQ6500_setEQ" block="set EQ:%eq"
